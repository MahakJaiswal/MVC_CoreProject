...
namespace Visitor_Management.Controllers
{
    ...
    public class MobApiController : Controller
    {
        ...
        [HttpGet("/api/GetEmployeeImageBlob/{visitorid}")]
        public FileContentResult GetEmployeeImageBlob(string visitorid)
        {
            var imageData = db.ExecuteDataSetFN("Fn_Get_Visitor_Image_By_Id", visitorid).Tables[0];
